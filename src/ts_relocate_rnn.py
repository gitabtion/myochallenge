...
from tianshou.utils.net.common import Recurrent, ActorCritic
...
if __name__ == '__main__':
    ...
    train_collector = ts.data.Collector(policy, envs, ts.data.VectorReplayBuffer(buffer_size, train_num, stack_num=32),
